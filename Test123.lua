...
do
    local sidebarStroke = applyStroke(SidebarShell.outline, Color3.fromRGB(255, 255, 255), 1, 0.92)
end
...
applyCorner(SidebarShell.background, 8)
...
WindowShell.sidebarTitle = createThemedText(SidebarShell.topZone, {
    ...
    BackgroundTransparency = 1,
    Position = UDim2.fromOffset(SidebarPadding, 8),
...
do
    ...
    do
        local profileStroke = applyStroke(profileCard, Color3.fromRGB(255, 255, 255), 1, 0.88)
    end
    ...
    do
        local avatarStroke = applyStroke(avatarShell, Color3.fromRGB(255, 255, 255), 1, 0.82)
    end
...
Layout.selectTab = function(id)
    ...
    for tabId, tab in pairs(Tabs) do
        ...
        tab.fill.BackgroundTransparency = selected and 0.88 or 1
        tab.fill.Visible = true
        if tab.activeBar then
            tab.activeBar.Visible = selected
        end
        tab.icon.ImageColor3 = selected and Theme.accent or Theme.textDim
